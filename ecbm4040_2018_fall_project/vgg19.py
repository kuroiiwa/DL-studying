...
#         assert red.get_shape().as_list()[1:] == [500, 500, 1] #return the shape of red
#         assert green.get_shape().as_list()[1:] == [500, 500, 1]
#         assert blue.get_shape().as_list()[1:] == [500, 500, 1]
        bgr = tf.concat(axis=3, values=[
            blue - VGG_MEAN[0],
            green - VGG_MEAN[1],
            red - VGG_MEAN[2],
        ])
#         assert bgr.get_shape().as_list()[1:] == [500, 500, 3]
